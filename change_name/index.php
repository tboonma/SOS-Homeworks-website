...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $err = "Please enter username to change.";
    } else{
    ...
    if(empty($username_err)){
        if (!$link) {
		  ...
		  $sql = "UPDATE `users` SET `name` = '" . $name . "' WHERE `users`.`username` = '" . $username . "'";
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Username required">
						<input class="input100" type="text" name="username" placeholder="Username to be change">
					...
					<div class="container-login100-form-btn">
                        <input type="submit" class="login100-form-btn" value="Change">
					</div>
